...
export async function POST(request: NextRequest) {
  console.log('=== EMAIL/CONTACT API ROUTE CALLED ===')
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 30px;">
              ...
              <div style="background-color: #ffffff; border: 2px solid #ec4899; border-radius: 8px; padding: 20px; margin: 25px 0;">
                <table style="width: 100%; border-collapse: collapse;">
                  <tr>
                    ...
                    <td style="padding: 10px 0; color: #111827; font-size: 16px; font-weight: 600;">${body.firstName} ${body.lastName}</td>
                  </tr>
                  <tr>
                    <td style="padding: 10px 0; color: #374151; font-size: 14px; font-weight: 700;">📧 EMAIL</td>
                    <td style="padding: 10px 0;"><a href="mailto:${body.email}" style="color: #db2777; text-decoration: none; font-size: 16px; font-weight: 500;">${body.email}</a></td>
                  </tr>
                  <tr>
                    <td style="padding: 10px 0; color: #374151; font-size: 14px; font-weight: 700;">📞 PHONE</td>
                    <td style="padding: 10px 0;"><a href="tel:${body.phone}" style="color: #db2777; text-decoration: none; font-size: 16px; font-weight: 500;">${body.phone}</a></td>
                  </tr>
                  ${body.company ? `
                  <tr>
                  ...
                  ` : ''}
                  <tr>
                    <td style="padding: 10px 0; color: #374151; font-size: 14px; font-weight: 700;">🎯 INTEREST</td>
                    <td style="padding: 10px 0; color: #111827; font-size: 16px; font-weight: 500;">${body.interest}</td>
                  </tr>
                </table>
              </div>
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="mailto:${body.email}" style="background: linear-gradient(135deg, #ec4899 0%, #d946ef 100%); color: #ffffff; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; display: inline-block; box-shadow: 0 4px 6px rgba(236, 72, 153, 0.3);">
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 40px 30px;">
              <p style="color: #374151; font-size: 17px; line-height: 1.8; margin-top: 0;">
                Dear <strong>${body.firstName}</strong>,
              </p>
              
              <p style="color: #374151; font-size: 16px; line-height: 1.8;">
                Thank you for reaching out to RLJ Enterprise! We've received your message and truly appreciate you taking the time to contact us. Our team is reviewing your inquiry and will get back to you within <strong>1-2 business days</strong>.
              </p>
              ...
              <div style="background-color: #f9fafb; border: 2px solid #e5e7eb; border-radius: 10px; padding: 25px; margin: 30px 0;">
                ...
                <div style="text-align: center;">
                  <a href="tel:+18604977160" style="display: inline-block; background: linear-gradient(135deg, #ec4899 0%, #d946ef 100%); color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; margin: 5px; box-shadow: 0 4px 6px rgba(236, 72, 153, 0.3);">
                    📞 (860) 497-7160
                  </a>
              ...
              <!-- Closing -->
              <p style="color: #374151; font-size: 16px; line-height: 1.8; margin: 30px 0 10px 0;">
